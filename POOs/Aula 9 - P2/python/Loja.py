...
loja.adicionar_produto("Bola de futebol", 100)
loja.adicionar_produto("Casaco", 150)
loja.adicionar_produto("Tênis", 140)
print()
print("-" * 100)
print()
loja.listar_produto()
...
loja.oferecer_promocao(0.1)  # Exemplo: 10% de desconto
print()
print("-" * 100)
print()
loja.realizar_venda("pix", usr1, 1, "Casaco")
print()
print("-" * 100)
print()
